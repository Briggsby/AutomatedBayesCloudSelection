...
% Very notable diminishing returns above 4 vCPUs between 2 and 4 vCPUs, an approximately 5-fold reduction in score gain. Price increase, however, is XX. Bigger was not better for between 4 and 8, suggesting either diminishing returns of a limit of the benchmark to utilize more vCPU cores.
\subsection{Bayesian Optimization}
\subsubsection{Results}
\subsubsection{Discussion}
